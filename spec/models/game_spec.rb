...
describe Game do
	it 'should initialize when both heros are chosen' do
		game1 = Game.new('warrior', 'priest')
		game1.user_hero.should eq 'warrior'
	end

	it 'should initialize when both heros are chosen' do
		game1 = Game.new('warrior', 'priest')
		game1.opponent_hero.should eq 'priest'
	end
